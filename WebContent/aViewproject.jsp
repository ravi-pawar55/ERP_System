                  ...
                  <thead>
                   ...
                   <% while(rs2.next()){ %>
                    <tr>
                     ...
                     <td><a href="aAddTaskEmp.jsp?pid=<%= rs2.getInt(1)%>" >Add</a></td>
                     <td><a href="aAddTaskDept.jsp?pid=<%= rs2.getInt(1)%>" >Add</a></td>
                     <td><a href="aViewReports.jsp?pid=<%= rs2.getInt(1)%>" >View</a></td>
                     <td><a href="viewplan.jsp?pid=<%= rs2.getInt(1)%>" >View</a></td>
                     <td><a href="aDeleteProject.jsp?id=<%= rs2.getInt(1)%>" >Delete</a></td>
                   </tr>
                   <%} %>
                 </tbody></table>
               </div>
