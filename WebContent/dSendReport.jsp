...
<div class="clearfix"></div>
 ...
 <% Connection con = DbConection.connect();
   ...
   PreparedStatement pst =con.prepareStatement(" select * from task where pid=? and empid=? "); 
   pst.setString(1,request.getParameter("pid"));
   pst.setInt(2,Getset.getEmpId());
   ResultSet rs = pst.executeQuery();
   
   if(rs.next())
   System.out.println("Proceed");
   else
   response.sendRedirect("dViewproject.jsp");
     ...
     <div class="row mt-3">
      <div class="col-lg-6">
         <div class="card">
           ...
           <hr>
            <form action="SendReportEmp" method="post" enctype="multipart/form-data">
