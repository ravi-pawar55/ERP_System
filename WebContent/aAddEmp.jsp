    ...
    <div class="row mt-3">
      <div class="col-lg-6">
         <div class="card">
           ...
           <hr>
            <form action="aInsertEmp.jsp" >
            
           <div class="form-group">
            <label for="input-1">Employee Name</label>
           ...
           <div class="form-group">
            <label for="input-3">Contact</label>
           ...
           <div class="form-group">
            <label for="input-3">Emergency Contact</label>
            <input type="text" class="form-control" name="emerc" placeholder="Enter Emergency Number">
           </div>
           <div class="form-group">
            <label for="input-5">Department Id</label>
