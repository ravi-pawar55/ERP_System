...
<div class="clearfix"></div>
  ...
  <!--Start Dashboard Content  class="form-control" class="form-group"-->	 
 ...
 <div class="row mt-3">
      <div class="col-lg-6">
         <div class="card">
           ...
           <hr>
            <form action="dInsertComment.jsp">
            <div class="form-group">
            <label for="input-1">Comment</label>
            <input type="text" class="form-control" name="cmt" placeholder="Write here">
           </div>
           ...
           <div class="form-group">
            <button type="submit" class="btn btn-light px-5">Send Comment</button>
          </div>
          </form>
         </div>
         </div>
