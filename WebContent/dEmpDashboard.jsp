...
<script>
alert("Ravi Construction ERP Says Login Successful.....");
</script>
-->
...
<div class="clearfix"></div>
 ...
 <% 
   ...
   PreparedStatement pstm =con.prepareStatement(" select * from task where empid=? ");
   pstm.setInt(1,Getset.getEmpId());
